...
// this above syntax is as similar below
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            ...
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("File is succesfully created with file desciptor : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorect parameters\n");
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("File is succesfully opened with file desciptor : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorect parameters\n");
            ...
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ret == -2)
                {
                    printf("ERROR : Permission dinied\n");
                }
                if(ret == -3)
                {
